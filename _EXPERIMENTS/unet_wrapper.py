...
class unet_wrapper:
    ...
    def load_npy(self):
        ...
        images = np.load(self.image_dir)
        masks = np.load(self.mask_dir)
    ...
    def train(self, x, y):
        ...
        x_train, x_val, y_train, y_val = train_test_split(x, y, test_size=0.429, random_state=0)
